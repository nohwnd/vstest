...
namespace Microsoft.TestPlatform.Extensions.TrxLogger.UnitTests
{
    ...
    public class TrxLoggerTests
    {
        ...
        public void CustomTrxFileNameShouldBeConstructedFromRelativeLogFilePrefixParameter(string prefixName)
        {
            ...
            Assert.AreNotEqual(Path.Combine(TrxLoggerTests.DefaultTestRunDirectory, "results_net461.trx"), this.testableTrxLogger.trxFile, "Expected time stamp to appear in file name");
            Assert.AreEqual(Path.Combine(TrxLoggerTests.DefaultTestRunDirectory, "results_net461"), actualFileNameWithoutTimestamp);
        }
        ...
        public void CustomTrxFileNameShouldBeConstructedFromAbsoluteLogFilePrefixParameter()
        {
            ...
            Assert.AreEqual(trxPrefix + "_net461", actualFileNameWithoutTimestamp);
