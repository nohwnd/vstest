...
namespace Microsoft.TestPlatform.AcceptanceTests
{
    ...
    public class DisableAppdomainTests : AcceptanceTestBase
    {
        ...
        public void DisableAppdomainTest(RunnerInfo runnerInfo)
        {
            ...
            var diableAppdomainTest1 = testEnvironment.GetTestAsset("DisableAppdomainTest1.dll", "net461");
            var diableAppdomainTest2 = testEnvironment.GetTestAsset("DisableAppdomainTest2.dll", "net461");
        ...
        public void NewtonSoftDependencyWithDisableAppdomainTest(RunnerInfo runnerInfo)
        {
            ...
            var newtonSoftDependnecyTest = testEnvironment.GetTestAsset("NewtonSoftDependency.dll", "net461");
