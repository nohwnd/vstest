...
namespace Microsoft.VisualStudio.TestPlatform.ObjectModel
{
    ...
    public class AttachmentSet
    {
        public AttachmentSet(Uri uri, string displayName)
        {
            ...
            this.Attachments = new List<UriDataAttachment>();
        }

        /// <summary>
        /// Gets URI of the sender.
        ...
        {
            return $"{nameof(this.Uri)}: {this.Uri.AbsoluteUri}, {nameof(this.DisplayName)}: {this.DisplayName}, {nameof(this.Attachments)}: [{string.Join(",", this.Attachments)}]";
        }
    }
}
