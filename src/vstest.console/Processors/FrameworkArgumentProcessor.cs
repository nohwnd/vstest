...
namespace Microsoft.VisualStudio.TestPlatform.CommandLine.Processors
{
    ...
    internal class FrameworkArgumentProcessor : IArgumentProcessor
    {
        ...
        public FrameworkArgumentProcessor(IServiceLocator serviceLocator)
        {
        ...
        public Lazy<IArgumentExecutor> Executor
        {
            get
            {
                ...
                {
                    this.executor = new Lazy<IArgumentExecutor>(() => new FrameworkArgumentExecutor(CommandLineOptions.Instance, this.serviceLocator.GetShared<IRunSettingsProvider>()));
                }
