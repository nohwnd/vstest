...
namespace Microsoft.VisualStudio.TestPlatform.CommandLine.Processors
{
    ...
    internal class ResultsDirectoryArgumentProcessor : IArgumentProcessor
    {
        ...
        public ResultsDirectoryArgumentProcessor(IServiceLocator serviceLocator)
        {
        ...
        public Lazy<IArgumentExecutor> Executor
        {
            get
            {
                ...
                {
                    this.executor = new Lazy<IArgumentExecutor>(() => new ResultsDirectoryArgumentExecutor(CommandLineOptions.Instance, this.serviceLocator.GetShared<IRunSettingsProvider>()));
                }
